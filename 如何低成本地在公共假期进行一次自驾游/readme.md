...
1. 一个12306账号只能下两单候补，配额十分珍贵：如果你去程下一单候补，回程下一单候补，你就用完了你的候补配额。而多单候补则需要操作2个甚至更多的12306账号，比较麻烦。
...
中转弃程是我自己发明的一个名字。简单来说，就是购买中转机票，只乘坐前段航班，不乘坐后段航班，因为中转地才是我们真正的目的地。
...
如果乘坐国航CA1222回北京，在完完全全一样的体验下，中转弃程方案将立刻帮你节省1300元。此外，后段（北京飞台州这一段）机票的燃油机建费是可以100%退掉的，还能再节省110元。你可以在出行时仅乘坐前段航班，不要值机后段，等到前段落地了之后再退掉后段机票。

甚至还有一个更骚的操作，就是前段航程落地后，不要着急退票，而是先等等看，如果后段航程出现计划变更或者起飞延误半小时以上（这两个事情发生的概率并不小），你可以将后段机票全退！例如，这个例子中兰州飞到台州有两段，这两段的票面价格分别是450元和350元。那么，在后段航班非正常的情况下，你可以再退掉350元的后段机票，从而实现了仅用450元+110元=560元就得到了与购买全价票的直飞乘客完全一样的出行体验。

有新建机场的地方更容易薅到这种中转低价羊毛。因为新建的机场往往客流尚未饱和，需要通过一些低价手段吸引客流，包括北京大兴、青岛胶东、成都天府、郑州新郑机场等等。

最后，需要注意的是中途有经停的航班不能这么操作的。因为乘坐经停航班本质上你只买了一张机票，而这张机票是不能拆分的。
...
事实上，所有的低价机票信息都是公开的。所以，互联网上**可能已经存在**一种功能强大的软件，它可以通过不断爬取公开的低价信息来及时地给你低价提醒，方便你设计出更省钱的出行方案。
